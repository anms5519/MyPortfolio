const certificationsData = [
    ...
    },
    {
        ...
        verificationLink:
            "Issued by Forage (Verification likely platform-specific via codes)",
        downloadLink: "",
        certificateImage: "images/certificates/c (21)", 
        learnings:
    ...
    },
    {
        ...
        verificationLink: "elearnmarkets.com/verify-certificate", 
        downloadLink: "",
    ...
    },
    {
        ...
        verificationLink: "Official Board Verification", 
        downloadLink: "",
        certificateImage: "images/certificates/ssc_academic.png", 
        learnings:
    ...
    },
    {
        ...
        downloadLink:
            "https://www.credly.com/badges/646332c0-679d-43a0-ac31-242ebd2c2bf9",
        certificateImage: "images/certificates/credly_gcp_badge_40.png", 
        learnings:
    ...
    },
    {
        ...
        downloadLink:
            "https://www.cloudskillsboost.google/public_profiles/d81586d4-bc86-436d-8fb9-ff5eaa221080/badges/14624727",
        certificateImage: "images/certificates/gcp_badge_41.png", 
        learnings:
    ...
    },
    {
        ...
        downloadLink:
            "https://www.cloudskillsboost.google/public_profiles/d81586d4-bc86-436d-8fb9-ff5eaa221080/badges/14624721",
        certificateImage: "images/certificates/gcp_badge_42.png", 
        learnings:
            "Digital badge showcasing completion of specific Google Cloud learning paths or challenges.",
        additionalDetails: "Verified via Google Cloud Skills Boost profile.",
        category: "Cloud Computing",
    ...
    },
    {
        ...
        downloadLink:
            "https://www.cloudskillsboost.google/public_profiles/d81586d4-bc86-436d-8fb9-ff5eaa221080/badges/14601970",
        certificateImage: "images/certificates/gcp_badge_43.png", 
        learnings:
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    function createCertCard(cert) {
        ...
        <div class="cert-hover">
          <p>${cert.learnings.substring(0, 120)}${
            cert.learnings.length > 120 ? "..." : ""
        }</p>
    ...
    function openLightbox(certId) {
        ...
        if (cert) {
          ...
          `;
                ...
                lbAdditional.innerHTML = `<strong>Details:</strong> ${
                    cert.additionalDetails || "No additional details available"
                }`;
            }
            if (lbCertificateImage) {
                ...
                if (cert.certificateImage) {
                    ...
                    switch (certId) {
                        ...
                        case 8:
                            imageFileName =
                                "images/certificates/MICS eLearning Course_Certificate.png";
                            break;
                        default:
                            const genericCerts = [
                            ...
                            imageFileName =
                                genericCerts[certId % genericCerts.length];
                    }
            ...
            if (
                ...
                cert.verificationLink.startsWith("http")
            ) {
    ...
    function updateNavigationButtons(currentId) {
        ...
        nextBtn.style.pointerEvents =
            currentIndex >= ids.length - 1 ? "none" : "auto";
    }
